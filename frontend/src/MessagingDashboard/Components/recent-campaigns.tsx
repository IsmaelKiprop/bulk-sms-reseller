...
import { CheckCircle, Clock, AlertCircle, MoreHorizontal, Copy, BarChart3, Trash2, Send } from "lucide-react"
              ...
              <TableCell className="text-right">
                <DropdownMenu>
                  ...
                  >
                    ...
                    <DropdownMenuItem>
                      <Link href={`/dashboard/campaigns/duplicate/${campaign.id}`} className="flex w-full items-center">
                    ...
                    {campaign.status === "scheduled" && (
                      <DropdownMenuItem>
                        <Link href={`/dashboard/campaigns/edit/${campaign.id}`} className="flex w-full items-center">
